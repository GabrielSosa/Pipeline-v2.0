...
function Interes_cp1() {
    var valor_presente = document.getElementById("valor_presente_cp1").value;
    var valor_futuro = document.getElementById("valor_futuro_cp1").value;
                        

    document.getElementById("interes_cp1").value = valor_futuro - valor_presente;       
  ...
  function TasaInteres_cp1(){
    ...
    var valor_presente1 = document.getElementById("valor_presente1_cp1").value;
                        

    document.getElementById("tasainteres_cp1").value = (interes_acumulado / valor_presente1)*100;
  ...
  function TasaDeRendimiento_cp1(){
    ...
    document.getElementById("tasainteres_rendimiento_cp1").value = (interes_acumulado / valor_presente1)*100;
...
function InteresCompuesto_cp1(){
    ...
    document.getElementById("interescompuesto_cp1").value =valor_presente3*Math.pow((parseFloat(tasa_de_interes1) + 1),numero_de_periodos1)-valor_presente3;
}
...
/** inicio cap 2*/
  ...
  function valor_futuro_cantidad_compuesta_cp2(){
            ...
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_cp2").value);

            document.getElementById("valor_futuro_compuesta_cp2").value = Math.round(valor_presente*Math.pow(tasa_interes+1,periodo_tiempo)*100)/100;

        }
        function valor_presente_inversion_inicial_cp2(){
            var valor_futuro=parseFloat(document.getElementById("valor_futuro_cp2").value);
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_2_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_2_cp2").value);

            document.getElementById("valor_presente_inicial_cp2").value=Math.round((valor_futuro/Math.pow(tasa_interes+1,periodo_tiempo)*100))/100;
        }
        function valor_presente_serie_uniforme_cp2(){
            var valor_anual=parseFloat(document.getElementById("valor_anual_cp2").value);
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_3_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_3_cp2").value);
            if (tasa_interes!=0){
                document.getElementById("valor_serie_uniforme_cp2").value= Math.round((valor_anual*(Math.pow((1 + tasa_interes), periodo_tiempo) - 1)/(Math.pow((1 + tasa_interes),periodo_tiempo)*periodo_tiempo))*100)/100;
            }else{
        ...
        function valor_anual_uniforme_cp2(){
            ...
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_4_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_4_cp2").value);
            document.getElementById("valor_anu_uniforme_cp2").value= Math.round((valor_presente*((tasa_interes * Math.pow((tasa_interes + 1), periodo_tiempo))/(Math.pow((1 + tasa_interes),periodo_tiempo) - 1)))*100)/100;

        }   

        function valor_anual_serie_uniforme_cp2(){
            var valor_futuro= parseFloat(document.getElementById("valor_futuro_2_cp2").value);
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_5_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_5_cp2").value);
            document.getElementById("valor_anu_serie_uniforme_cp2").value= Math.round((valor_futuro*(tasa_interes/(Math.pow((1 + tasa_interes),periodo_tiempo) - 1)))*100)/100;

        }

        function valor_futuro_serie_uniforme_cp2(){
            var valor_anual= parseFloat(document.getElementById("valor_anual_2_cp2").value);
            var tasa_interes=parseFloat(document.getElementById("tasa_interes_6_cp2").value);
            var periodo_tiempo=parseFloat(document.getElementById("periodo_tiempo_6_cp2").value);
            document.getElementById("valor_futu_serie_uniforme_cp2").value= Math.round((valor_anual*((Math.pow((1 + tasa_interes),periodo_tiempo) - 1)/tasa_interes))*100)/100;
        ...
        function flujo_efectivo_anio_cp2(){
            ...
            document.getElementById("flujo_efec_anio_cp2").value= Math.round((cantidad_base + (periodo_tiempo - 1) * gradiante)*100)/100;
        ...
        function gradiente_aritmetico_cp2(){
            var tasa_interes= parseFloat(document.getElementById("tasa_interes_7_cp2").value);
            ...
            document.getElementById("gradiente_arit_cp2").value= Math.round((gradiante / tasa_interes * (((Math.pow((tasa_interes + tasa_interes),periodo_tiempo) - 1)/ tasa_interes * Math.pow((1 + tasa_interes),periodo_tiempo))-(periodo_tiempo/Math.pow((1 + tasa_interes),periodo_tiempo))))*100)/100;

        }

        function serie_anual_uniforme_cp2(){
            var tasa_interes= parseFloat(document.getElementById("tasa_interes_8_cp2").value);
            ...
            document.getElementById("serie_anu_uniforme_cp2").value = Math.round((gradiante * ((1/tasa_interes)-(periodo_tiempo/Math.pow((1 + tasa_interes),periodo_tiempo) - 1)))*100)/100;

        }

        function factor_gradiente_aritmetico_cp2(){
            var tasa_interes= parseFloat(document.getElementById("tasa_interes_9_cp2").value);
            ...
            document.getElementById("factor_gra_uniforme_cp2").value= Math.round((gradiante * ((1/tasa_interes)*(((Math.pow((1 + tasa_interes),periodo_tiempo) - 1) / tasa_interes) - periodo_tiempo)))*100)/100;
...
//        n= numero de periodos
        var t=document.getElementById("ti_tasa_cp4").value/100;
        var n=document.getElementById("ti_p_cp4").value;
        document.getElementById("ti_cal_cp4").value= t*n;

    }

    // Tasa de interes efectiva
    function Tasa_Efectiva_cp4(){
